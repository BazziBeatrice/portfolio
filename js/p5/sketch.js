...
function mostraImmagine11() {
  image(img11, mouseX, mouseY - 40, (img.width / 5), (img.height / 4))}
function mostraImmagine12() {
  image(img12, mouseX, mouseY - 60, (img.width / 4), (img.height / 4.5))}
function mostraImmagine13() {
  image(img13, mouseX, mouseY - 120, (img.width / 5.5), (img.height / 4))}
